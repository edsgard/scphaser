...
main <- function(){
    ...
    ##for browseVignettes() to work one also needs a inst/doc/index.html file
    ##this is generated by install_github('edsgard/scphaser', build_vignettes = TRUE) #however, to build the vignettes require a working pandoc installation
