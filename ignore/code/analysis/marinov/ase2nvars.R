...
###library('devtools')
###devtools::load_all()
###source("ignore/code/analysis/marinov/ase2nvars.R")
...
##OUT
out_rds_dir = '../nogit/data/marinov'
out_pdf_dir = './ignore/res/marinov/perf/pdf'
