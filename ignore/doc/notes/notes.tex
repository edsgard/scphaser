...
##weighted version of phase_clustering: wcKMedoids or weighted dist matrix.
...
##weighing
##*###
##Clustering: can probably weigh every element in a distance matrix calculation
##otherwise, probably use wcKMedoids where w_jvar = P_jvar / sum(P_jvar) and P_jvar = sum(log(P))

##*###
##gene phasing reliability score
##*###
##possibly meta-analysis of jvar p-values (similar to geneiase). But this is basically a measure that not biallelic.
